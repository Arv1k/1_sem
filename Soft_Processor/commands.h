DEF_CMD(PUSH, 65, {
                    ...
                    if (reg[0] == '[') {
                        ...
                        if (sscanf(str, "%s [%3s + %d]", com, reg, &var) == 3) {
                        	WHICH_REG(MD_PUSH_FROM_RAM_WITH_NUM_REG);
						...
						else if (sscanf(str, "%s [%3s - %d]", com, reg, &var) == 3) {
                        	WHICH_REG(MD_PUSH_FROM_RAM_WITH_NUM_REG);
...

                  {
                        ...
                        switch (bytecode[pc]) {
							...
							case MD_PUSH_FROM_RAM_WITH_NUM_REG:
                                PC('c');
...
DEF_CMD(POP, 66, {
		            ...
		            if (reg[0] == '[') {
		                ...
		                if (sscanf(str, "%s [%3s + %d]", com, reg, &var) == 3) {
                        	WHICH_REG(MD_POP_IN_RAM_WITH_NUM_REG);
				  ...
				  
				 {
	                ...
	                switch (bytecode[pc]) {
	                    ...
	                    case MD_POP_IN_RAM_WITH_NUM_REG:
	                        PC('c');
...
DEF_MD(POP_IN_RAM_WITH_NUM_REG, 41) // )
DEF_MD(PUSH_FROM_RAM_WITH_NUM_REG, 42) // *
